...
```text
https://ijudge.it.kmitl.ac.th/submissions/555287/overview
```
...
```text
โจทย์ต้องการให้เรา ใส่ input ที่เป็นตัวอักษร 5 ตัว แล้ว output ต้องออกมาเป็นตัว input ที่ตัวอักษรเปลี่ยนจากด้านหน้าไปหลัง แต่มีจุดสำคัญนั้นก็คือ output ต้องเป็นตัวพิมพ์เล็กเท่านั้น
```
...
2. รับข้อความจากผู้ใช้แล้วเก็บไว้ในตัวแปร text
3. สลับลำดับตัวอักษรของข้อความจากหลังมาหน้า
4. ทำให้ output เปลี่ยนเป็นตัวอักษรตัวพิมพ์เล็กเท่านั้น
