...
```text
ไปตามแผนแรก สร้างชื่อของตัวโจทย์นี้ก็คือ สลับตัวอักษร และต่อมาทำการสร้าง Function ชื่อว่า main ทำตามที่โจทย์ต้องการ กำหนดตัวแปลเป็น text แล้วโจทย์ต้องการ print output ให้สลับและต้องเป็นตัวพิพม์เล็ก print(text[::-1].lower()) text คือ ตัวอักษรที่เรากรอกเข้าไป [::-1]ตามปกติการกรอก จะเป็น [0,0,0] 0 ตัวแรก จุดเริ่ม การว่างไว้จะไม่นับ 0 ตัวที่สอง คือจุดหยุด ว่างไว้เช่นกัน และสุดท้าย คือจุดเดิน การใส่ -1 จะเป็นการเดินย้อนกลับทีละ 1 ตำแหน่ง แต่กับอักษรจะเป็นการสลับที่จากขวาไปซ้ายแทน สุดท้ายใส่ lower เพื่อให้ผลลัพทธ์จาก input เป็นตัวพิมพ์เล็กเสมอ
```
...
```text
เป็นการพิมพ์ตัวพิมพ์ใหญ่ทั้งหมด เพื่อหาว่าจะแปลงเป็นตัวพิมพ์เล็กทั้งหมดไหม
```
...
```text
เป็นการหาว่า ถ้ามีพิมพ์ใหญ่ พิมพ์เล็กสลับไปกันมา จะแสดงผลได้เหมือนเดิมหรือไหม
```
...
```text
ถ้าใส่เป็นตัวเลชที่นับค่าเป็นตัวอักษร กับตัวอักษรแล้วจะแสดงผลเป็นยังไง
```
...
```text
อ่านโจทย์ วิเคราะห์ ทำแผนและลงมือทำ
```
