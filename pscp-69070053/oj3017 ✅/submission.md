...
```text
https://ijudge.it.kmitl.ac.th/submissions/563653/overview
```
...
```text
โจทยนี้ต้องการให้เราหา ค่าอาหาร (จำนวนเต็ม) ของเราโดยที่จะคิดค่าบริการ เป็น 10% ของราคาค่าอาหาร แต่ ค่าบริการมีขั้นต่ำ ถ้าค่าอาหารน้อยกว่า  50 บาท ให้คิดเป็น 50 เลย แต่คาบริการจะไม่เกิน 1000 บาท แล้วร้านมีคิด vat7% ในขั้นสุดท้ายก่อน output เป็นราคาค่าอาหารจริง (ตอบเป็นจำนวนทศนิยม สองต่ำแหน่ง)
```
...
```text
สร้าง ฟังชั้น bill 
กำหนดตัวแปร  ค่าอาหาร food_bill ให้เป็น จำนวนเต็ม ใช้ int
กำหนดตัวแปร ค่าบริการ ให้เท่ากับ 10% ของค่าอาหาร

สร้างโลจิก if  โดยการที่ถ้า ค่าบริกาน้อยกว่า 50 ค่าบริการจะเท่ากับ 50 
และ elif ถ้า ค่าบริการมากกว่า 1000 ค่าบริการจะเท่ากับ 10000

สร้างตัวแปรที่รวมค่า อาหารและค่าบริการเข้าด้วยกัน
สร้างตัวแปร ค่าvat7% โดยที่ จะตัวแปรที่สร้างจากค่าอาหาร บวกกับ ค่าบริการ ไปคูณ 7%  (0,7)

สร้างตัวแปร ที่บวกตัวแปรที่รวมค่าอาหารและค่าบริการ บวกกับ ค่าvat7%
สร้างตัวแปรที่จะแสดงผลค่าอาหาร โดยที่กำหนดให้แสดงผลที่มีเลข จุดทศนิยมสองต่ำแหน่ง
...
```text
ได้ทำการทำตามแผนแรก อย่างระเอียยด
การใช้ if ก็เพิ่อกำหนดว่า ถ้าค่าอาหารน้อยกว่า 50 หรือมาากกว่า 1000  จะให้กลายเป็นค่านั้น เช่น ค่าอาหาร 12 เมื่อบวกค่าบริการจะกลายเป็น 62 
```
...
```text
เพื่อจะทดสอบว่าหากใส่จำนวนเลขที่มีเลขทศนิยมจะเกิดอะไรขึ้น
```
...
```text
เพื่อหาว่าถ้าค่าอาหารเป็นศูนย์จะเกิดอะไรขึ้น
```
...
```text
ตรวจว่าถ้าใส่ค่าอาหารที่ติดลบจะเกิดอะไรขึ้น
```
