...
```text
ผมใช้ AI เพื่อช่วยตรวจสอบความเข้าใจโจทย์และชี้ให้เห็นรายละเอียดที่ผมมองข้ามและตรวจสอบความเข้าใจในโจทย์กับริวิแผนแรกของผม
```
...
```text
AI ช่วยให้ผมสังเกตุว่า โจทย์ไม่ได้แสดงผล เมื่อผลลัพทธ์ จึงต้องกำหนดว่า ถ้ามากกว่า 0 ให้แสดงผลทำให้ถ้าน้อยกว่าเท่ากับ 0 จะไม่แสดงผล 
```
...
```text
ผมตรวจการใช้เครื่องหมายให้ถูกต้องและตรวจสอบการแสดงผลว่าเป็นไปตามรูปแบบ สระ  : จำนวณสระ จริงๆ
```
...
```text
ผมได้เรียนรู้คำสั่งอย่าง .count ซึ่ง .count() ใช้นับว่าข้อมูลที่กำหนดปรากฏอยู่ในข้อความกี่ครั้ง
```
