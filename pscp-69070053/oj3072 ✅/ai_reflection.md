...
| Item | Answer |
|---|---|
| OJ problem number/title | OJ3072 - [LEARNING LOGS] A-E-I-O-U |
| OJ submission ID, if submitted | https://ijudge.it.kmitl.ac.th/submissions/587407/overview |
| OJ status | Pass |
...
```text
ผมใช้ AI เพื่อช่วยตรวจสอบความเข้าใจโจทย์และชี้ให้เห็นรายละเอียดที่ผมมองข้ามและตรวจสอบความเข้าใจในโจทย์กับริวิแผนแรกของผม แล้วยังอธิบายหลักการใช้ list 
```
...
```text
AI ช่วยให้ผมสังเกตุว่า โจทย์ไม่ได้แสดงผล เมื่อผลลัพทธ์ ไม่มีตัวอักษรไหนเลยที่เป็นสระภาษาอังกฤษ จึงต้องทำลูปตรวจสอบอีกครั้ง
```
...
```text
ผมตรวจการใช้เครื่องหมายให้ถูกต้อง การตั้งตัวแปร สระ ต้องมี "_" ด้วยไม่งั้นจะผิดผลาดและตรวจสอบการแสดงผลว่าเป็นไปตามรูปแบบ สระ  : จำนวณสระ จริงๆ
```
...
```text
ผมได้เรียนรู้คำสั่งอย่าง index คือ เลขตำแหน่งของข้อมูล และ .index() ค้นหา Index ของข้อมูลที่กำหนด จึงสามารถหาต่ำแหน่งได้ว่าตัวอักษรนั้นอยู่ลำดับที่เท่าไร ใน a e  i o u 
```
