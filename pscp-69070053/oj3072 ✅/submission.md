...
```text
https://ijudge.it.kmitl.ac.th/submissions/587631/overview
```
...
สร้างรูป ในตัวแปรสระภาษาอังกฤษ ข้างในมี "aeiou"
 ตัวแปรการนับ จะเท่ากับ ข้อความ.count(ตัวสระ) เพื่อเป็นการนับ
สร้างคำสั่ง  if ถ้าตัวแปรนับมากกว่า 0 
แสดงลัพทธ์
...
การใช้ลูป เพื่อตรวจว่า ใน textแต่ละตัว มี  ตัวอักษร "aeiou" หรือไม่ถ้ามี จะเก็บไว้ในตัวแปร count โดยใช้คำ.count(ตัวสระ) 
.count()ทำงานโดยการนับว่าข้อมูลที่กำหนดปรากฏอยู่ในข้อความกี่ครั้ง
ลุปได้ทำการกำหนดว่าจะเรียง ตาม aeiouเพราะฉะนั้น output จะเรียงการเป็น
a
e
i
o
