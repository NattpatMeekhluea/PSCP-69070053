...
```text
https://ijudge.it.kmitl.ac.th/submissions/588885/overview
```
...
```text
จทย์ต้องการสร้างสะพานตามความยาวที่กำหนด แล้วให้อิฐมาสองขนาด 
a ขนาดเล็ก ความยาว 1 นิ้ว b ขนาดใหญ่ ความยาว 5 นิ้ว 
โดยมีข้อแม้ว่าจะใช้อิฐก้อนใหญ่ให้ได้มากที่สุด แต่ใช้ก้อนเล็กก่อนเสมอ โดยที่ต้องสร้างให้พอดีกลับทีกำหนด ถ้าก้อนใหญ่เกิน ใช้เท่าที่ได้ แล้วก้อนเล็กโปะ  
input 1 ก้อนอิฐ a 
input 2 ก้อนอิฐ b 
input 3 ความยาวที่เราต้องสร้าง
output จำนวนอิฐก้อนเล็กที่ต้องใช้ ถ้าไม่สามารถสร้างได้ให้ตอบเป็น -1 ไปเลย
```
...
```text
กำหนดตัวแปรทั้งสามตัว  จำนวณอิฐเล็ก,ใหญ่ และความยาวที่ต้องการสร้าง

หาจำนวณอิฐก่อนใหญที่ใช้ในการสร้างสะพาน หาจากการนำ ความยาวที่ต้องการจะสร้าง หารไม่เอาเศษ กับ 5 (ความยาวของอิฐก้อนใหญ่), จำนวณอิฐก้อนใหญ่

จากนั้นสร้างตัวแปรเก็บข้อมูลว่าเหลือความยาวเท่าไรหลักจากที่ใช้อิฐก้อนใหญ่ โดยหาจากการนำ ความยาวที่ต้องการขจะสร้าง - จำนวณอิฐก้อนใหญ่ที่ใช้ไป คูณกับ ความยาวของอิฐก้อนใหญ่ ในที่นี้คือ 5 

ใช้คำสั้ง if เพื่อหาจำนวณอิฐก้อนเล็กใช้ไป
ถ้า จำนวณอิฐก้อนเล็ก มากกว่าเท่าากับ ความยาวที่เหลือ จะแสดงผลตามความยาวนั้นเพราะ อิฐก้อนเล็ก ความยาว 1 นิ้ว
ถ้าไม่ให้แสดงลบหนึ่ง
...
```text
เป็นไปตามแผนแรก
การใช้ตัวแปร large_use เพื่อหาว่าเราใช้ตัวอิฐก้อนใหญ่ไปเท่าไร 
การใช้ min เพื่อหาเลขที่น้อยที่สุดในสมการการหาจำนวณอิฐที่ใช้ อย่าง 17 //  5, อิฐก้อนใหญ๋
17 หารไม่เอาเศษ 5 จะเหลืิอ 3 
= min(3,5)  3 น้อยสุดจึงเก็บข้อมูล 3 ใว้
```
...
```text
เพื่อทดสอบว่าถ้าอิฐมีเกินจะแสดงผลยังไง
```
...
```text
ถ้าให้อิฐเล็กเป็น 0 จะแสดงผลยังไง
```
