...
| OJ submission ID, if submitted | https://ijudge.it.kmitl.ac.th/submissions/589319/overview |
| OJ status | Pass |
...
```text
AI ช่วยอธิบายโจทย์และสูตรคำนวณให้เข้าใจง่ายขึ้น แล้วริวิวแผนแรกของผม และการใช้ map
```
...
```text
ช่วยให้สังเกตุว่า การใช้ map จะเป็นการทำให้ input เป็น int ทั้งหมด
```
...
```text
ผมตรวจสอบสิ่งที่โจทย์ต้องการและการใช้ input ต้องมี input สองตัวใน 1 บรรทัด 
```
...
```text
ได้เรียนรู้การใช้ math ceil เพื่อปัดเศษขึ้น และสมการการคิด
```
