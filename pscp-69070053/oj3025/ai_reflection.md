...
| OJ submission ID, if submitted | https://ijudge.it.kmitl.ac.th/submissions/565706/overview |
| OJ status | Pass |
...
```text
ให้ Ai ช่วยริวิวแผนที่ทำมาและช่วยตรวจสอบว่าสามารถทำงานได้หรือไหม
```
...
```text
ai ช่วยสักเกตว่าผมมีการใช้ ชื่่อตัวแปรที่ซ้ำกับชื่อฟังชั้นและการแสดงผลจะผิดผลาดเพราะผมใช้ตัวพิมพ์ใหญ่แต่โจทย์ให้ผมใช้ตัวผิดเล็ก
```
...
```text
ผมตรวจสอบตัว pep8 ไม่ว่าจะเป็นพื้นที่ว่างและหลังจากที่ได้ตรวจสอบผ่านระบบ oj ก็ผมว่าผมผ่าน testcase แต่ไม่ผ่าน pep8 เพราะว่า มีการใช้ or ใน ฟั้งชั้น if elif else มากเกินไป จึงเปลี่ยนวิธีเขียนให้แบ่งเป็นการคิดสองรอบและลดรูปลงมาให้อ่านง่ายขึ้น 
```
...
```text
ai ช่วยให้ผมตรวจสอบค่าการแสดงผลให้ดีเพราะโจทย์กำหนดว่าตัวพิพม์เล็ก และการช่วยผมในการลดรูปเขียนให้โค้ดผม  สามารถอธิบายและทำความเข้าใจได้ง่ายมากขึ้น  ช่วยผมในาการตรวจสอบบัค 
```
